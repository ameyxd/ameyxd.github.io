    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${fontVariables} font-sans`}>
        ...
        >
          ...
          {/* Site Footer */}
          <div data-site-chrome className="w-full border-t py-8 mb-24 bg-background/50">
          ...
          {/* Bottom Links */}
          <div data-site-chrome className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
